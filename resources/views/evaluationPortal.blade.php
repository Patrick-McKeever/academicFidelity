...
<div id = "app">
    ...
    <div class = "wrapper">
        <nav class = "vertical">
            <ul>
                <li>
                    <label for = "home">TEACHERS</label>
                    <input type = "radio" name = "verticalMenu" id = "home">
                    <div>
                        <teacher-list ref = "teacherList"></teacher-list>
                    </div>
                </li>
            </ul>
            <ul>
                <li>
                    <label for = "home">MY OBSERVATIONS</label>
                    <input type = "radio" name = "verticalMenu" id = "home">
                    <div>
                        <obs-list ref = "obsList" :pre = "false"></obs-list>
                    </div>
                </li>
            </ul>
            <ul>
                <li>
                    <label for = "home" ref = "preObsList" :pre = "true">MY PRE-OBSERVATIONS</label>
                    <input type = "radio" name = "verticalMenu" id = "home">
                    <div>
                        <obs-list ref = "obsList" :pre = "true"></obs-list>
                    </div>
                </li>
            </ul>
        </nav>
    ...
    <div id = "mainBox">
        <router-view name = "navTabView" ref = "navTabView" :key = "$route.fullPath"></router-view>
    </div>
</div>
